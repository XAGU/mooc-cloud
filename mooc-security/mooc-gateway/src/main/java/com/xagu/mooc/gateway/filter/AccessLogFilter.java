...
import com.xagu.mooc.base.tools.IpUtil;
import com.xagu.mooc.gateway.pojo.GatewayLog;
...
public class AccessLogFilter implements GlobalFilter, Ordered {
    ...
    private Mono writeBodyLog(ServerWebExchange exchange, GatewayFilterChain chain,
        ...
        return bodyInserter.insert(outputMessage, new BodyInserterContext())
            .then(Mono.defer(() -> {
                // 重新封装请求
                ServerHttpRequest decoratedRequest = requestDecorate(exchange, headers,
                    outputMessage);
        ...
        return new ServerHttpResponseDecorator(response) {
            ...
            public Mono<Void> writeWith(Publisher<? extends DataBuffer> body) {
                if (body instanceof Flux) {
                    ...
                    // 计算执行时间
                    long executeTime = (responseTime.getTime() - gatewayLog.getRequestTime()
                        .getTime());
